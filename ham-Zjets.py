...
def initialize(params, selector):
    ...
    analysis.jet_ptmin = 30.0
    analysis.jet_etamax = 4.4
    analysis.lepton_ptmin = 20.0
    analysis.lepton_etamax = 2.47
    analysis.lepton_etagap_min = 1.37
    analysis.lepton_etagap_max = 1.52
    analysis.vboson_onshell_mass = 91.1876
    analysis.vboson_mass_max = 116.0
    analysis.vboson_mass_min = 66.0
    analysis.etmiss_min = 0.0
    analysis.lepton_jet_Rsep = 0.5;
    analysis.lepton_lepton_Rsep = 0.2;
    ...
    ROOT.Grid.aparam = 5.
    ROOT.Grid.born_alphaspower = selector.born_alphaspower
